...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError(msg || 'Số điện thoại hoặc mật khẩu không đúng');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="flex-1 flex flex-col justify-center space-y-8">
            <div>
              <h2 className="text-3xl font-bold leading-snug">
                Hệ thống quản lý<br />phòng khám da liễu
              </h2>
              <p className="text-blue-200/70 mt-3 text-sm leading-relaxed">
                Nền tảng số hóa toàn bộ quy trình khám chữa bệnh, từ đặt lịch đến bệnh án điện tử.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {[
                ...
                { icon: 'payment',  text: 'Thanh toán và hoá đơn tự động' },
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between px-8 py-5 border-b border-gray-100">
          ...
          <span className="text-sm text-gray-400">
            Chưa có tài khoản?{' '}
            <Link to="/register" className="text-[#1a3a5c] font-semibold hover:underline">Đăng ký</Link>
          </span>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-sm">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 mt-1">Nhập số điện thoại và mật khẩu để tiếp tục</p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 text-center text-sm text-gray-500">
              Chưa có tài khoản?{' '}
              <Link to="/register" className="text-[#1a3a5c] font-semibold hover:underline">
                Đăng ký bệnh nhân
              </Link>
            </div>
          </div>
